...
public class Core
{
    ...
    // DECLARE the reference to a list of DisplayObjects, call it _displayables:
    private ArrayList<DisplayObject> _displayables;
    ...
    public Core()
    {
        ...
        _displayables = new ArrayList<DisplayObject>();
     ...
     *
     * @param       displayable - a displayable of type DisplayObject
     * @return      void
     */
    public void addDisplayObject(DisplayObject displayable)
    {
     ...
     *
     * @param       displayable - the displayable of type DisplayObject to be removed
     * @return      void
     */
    public void removeDisplayObject(DisplayObject displayable)
    {
